                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox bg-white radius-bordered">
                                        ...
                                        <div class="databox-right">
                                            <span class="databox-number themesecondary">400</span>
                                            <div class="databox-text darkgray">Jumlah Barang</div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox bg-white radius-bordered">
                                        ...
                                        <div class="databox-right">
                                            <span class="databox-number themethirdcolor">109</span>
                                            <div class="databox-text darkgray">Jumlah Suplier</div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox bg-white radius-bordered">
                                        ...
                                        <div class="databox-right">
                                            <span class="databox-number themeprimary">100</span>
                                            <div class="databox-text darkgray">Barang keluar</div>
                                  ...
                                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox bg-white radius-bordered">
                                        ...
                                        <div class="databox-right">
                                            <span class="databox-number themeprimary">30</span>
                                            <div class="databox-text darkgray">Barang masuk</div>
                                            <div class="databox-state bg-themeprimary">
                                                <i class="fa fa-check"></i>
                                            </div>
                                        </div>
